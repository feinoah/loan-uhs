package com.jhh.jhs.loan.service.baikelu;

import com.alibaba.dubbo.common.logger.Logger;
import com.alibaba.dubbo.common.logger.LoggerFactory;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.jhh.jhs.loan.api.baikelu.BaikeluRemindService;
import com.jhh.jhs.loan.api.entity.ResponseDo;
import com.jhh.jhs.loan.common.enums.BaikeluRemindEnum;
import com.jhh.jhs.loan.common.util.*;
import com.jhh.jhs.loan.common.util.http.AOSHttpClient;
import com.jhh.jhs.loan.common.util.http.AOSJson;
import com.jhh.jhs.loan.common.util.http.HttpRequestVO;
import com.jhh.jhs.loan.common.util.http.HttpResponseVO;
import com.jhh.jhs.loan.entity.baikelu.BaikeluRemind;
import com.jhh.jhs.loan.entity.baikelu.BaikeluRemindExcelVo;
import com.jhh.jhs.loan.entity.baikelu.BaikeluRemindVo;
import com.jhh.jhs.loan.mapper.baikelu.BaikeluRemindMapper;
...
public class BaikeluRemindServiceImpl implements BaikeluRemindService {
    ...
    public ResponseDo sendBaikeluRemindApi(List<BaikeluRemindVo> remindVoList, String type) {
        ...
        if(StringUtils.isEmpty(baikeluIsSend)||!BaikeluRemindEnum.IS_OPEN_BAIKELU.getCode().equals(baikeluIsSend)){
            logger.info("【sendBaikeluRemindExcel】请求接口数据====>百可录接口未打开，查无【JHS_baikelu_all_onOff】redis数据");
