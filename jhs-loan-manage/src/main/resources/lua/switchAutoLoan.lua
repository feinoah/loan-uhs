--自动放款总开关Key
local totalSwitch = '{autoLoan}JHS_b_autoLoan_status'

--自动放款当前金额Key
local amount = '{autoLoan}JHS_b_autoLoan_amount'

--自动放款当前并发Key
local concurrency = '{autoLoan}JHS_b_autoLoan_concurrency'

--自动放款金额限制Key
local amountLimit = '{autoLoan}JHS_b_autoLoan_amount_limit'

--自动放款并发限制Key
local concurrencyLimit = '{autoLoan}JHS_b_autoLoan_concurrency_limit'
