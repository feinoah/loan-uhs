...
import com.jhh.jhs.loan.common.util.HttpUtils;
...
import com.jhh.jhs.loan.manage.service.impl.RobotServiceImpl;
...
public class RobotController extends BaseController{
	...
	/**
	 * 百可录提醒电话开关设置
	 * @param1.总开关redisKey：JHS_baikelu_all_onOff  2.flag:true打开，false关闭
	 * @throws Exception
	 */
	...
	public String callBackRemindApi(HttpServletRequest request) throws Exception {
		...
		try {
			...
			response= JSONObject.toJSONString(baikeluRemindService.baikeluCallbackRemindApi(jobRef,jobData));
		}catch (Exception  e){
			e.printStackTrace();
			logger.info("callBackRemind接口异常:",e);
