...
public interface CollectorsService {
     ...
     * @return
     */
    PageInfo<Collectors> selectCollectors(Map<String, Object> queryMap, int offset, int size, String userNo);
     ...
     * @return
     */
    int editCollectors(Collectors collectorsLevel);
     ...
     * @return
     */
    List<Collectors> selectCollectors();
     ...
     * 更新渠道商扣量百分比
     */
    ManagerResult updateChannelPercent(Collectors collectors);
