...
import com.jhh.jhs.loan.entity.manager_vo.PhoneBookVo;
import com.jhh.jhs.loan.manage.entity.Response;
import com.jhh.jhs.loan.manage.mapper.PersonMapper;
import com.jhh.jhs.loan.manage.service.report.ReportService;
...
public class ReportServiceImpl implements ReportService {
    ...
    public JSONArray getContact(Integer perId) {
        if (Detect.isPositive(perId)) {
            ...
            if (person != null && Detect.notEmpty(person.getContactUrl())) {
                String bf = HttpUtils.sendGet(person.getContactUrl(), "");
