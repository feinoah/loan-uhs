package com.jhh.jhs.loan.manage.service.loan;
...
import com.jhh.jhs.loan.entity.manager.CollectorsListVo;
import com.jhh.jhs.loan.entity.manager.CollectorsRemark;
import com.jhh.jhs.loan.entity.manager.Download;
import com.jhh.jhs.loan.entity.manager_vo.LoanInfoVo;
import com.jhh.jhs.loan.entity.manager_vo.LoanManagementVo;
import com.jhh.jhs.loan.manage.entity.AskCollection;
import com.jhh.jhs.loan.manage.entity.LoansRemarkOutVo;
import com.jhh.jhs.loan.manage.entity.LoansRemarkVo;
...
public interface LoanManagementService {
     ...
     * @return
     */
    PageInfo<Collectors> selectReceiptUsers(Map<String, Object> queryParams, String userNo, Integer type, int offset, int size);
    PageInfo<Collectors> selectReceiptUsers(String type, int offset, int size);
