...
import com.jhh.jhs.loan.api.entity.cash.WithdrawalVo;
import com.jhh.jhs.loan.api.sms.SmsService;
import com.jhh.jhs.loan.common.enums.MsgTemplateEnum;
...
import com.jhh.jhs.loan.common.util.thread.AsyncExecutor;
import com.jhh.jhs.loan.common.util.thread.runner.AbstractRetryRunner;
import com.jhh.jhs.loan.common.util.thread.runner.AbstractSimpleRunner;
...
import com.jhh.jhs.loan.manage.entity.SimpleResp;
import com.jhh.jhs.loan.manage.mapper.*;
import com.jhh.jhs.loan.manage.service.Commission.CommissionReviewService;
        ...
        if(commissionReviews!=null&&commissionReviews.size()>0)
            for(int i=0;i<commissionReviews.size();i++){
                ...
                if(null!=commissionReview.getEmployNum()&&!"".equals(commissionReview.getEmployNum())) {
                    List<Collectors> list = collectorsMapper.selectUserBySysNo(commissionReview.getEmployNum());
