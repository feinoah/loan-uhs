var setToolBar_lmg = function(){
    ...
    $("#btnReduce_loan").click(function () {
        ...
        $.ajax({
            ...
            data: {contractId:contractId,reduce:reduceAmount,remark:remark,type:6,userName:usernum,bedueDays:bedueDays},
    ...
    $("#btnOffline").click(function () {
        ...
        $.ajax({
            type:'POST',
            url: "loanManagement/reduceLoan.action",
            data: {contractId:contractId,reduce:offlineAmount,remark:remark,type:7,userName:usernum,bedueDays:bedueDays},
            success: function(result) {
...
var initLoanManagementTable = function () {
    ...
    tableUtils.initMuliTableToolBar(
        ...
        [
            ...
            {dataField : "bedueDays",fixed: true,caption : "逾期天数",alignment : "center",allowFiltering:true,filterOperations:["=",">","between"],allowSorting:true},
            ...
            {dataField : "rental",caption : "应还租金",alignment : "center",allowFiltering:false,allowFiltering:false,allowSorting:false},
            {dataField : "ransom",caption : "回购手机费",alignment : "center",allowFiltering:false,allowFiltering:false,allowSorting:false},
            {dataField : "penalty",caption : "应还违约金",alignment : "center",allowFiltering:false,allowSorting:false},
            {dataField : "deposit",caption : "押金",alignment : "center",allowFiltering:false,allowSorting:false},
            ...
            {dataField : "endDateString",caption : "到期日",alignment : "center",allowFiltering:true,filterOperations:["=","between"],allowSorting:true,
                dataType:"date",calculateCellValue: function (data) {
            ...
            {dataField : "borrStatus",caption : "合同状态",alignment : "center",allowFiltering:true,allowSorting:false,
                lookup:{
                    dataSource:[
            ...
            {dataField : "surplusAccountAmount",caption : "账户余额",alignment : "center",allowFiltering:false,filterOperations:["="],allowSorting:true}
        ],
        "贷后管理导出"+new Date(),
        function(e){
                                ...
                                if (selectobj[0].stateString == "逾期结清" || selectobj[0].stateString == "正常结清") {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (result) {
                                            ...
                                            var maxReduce = 0 ;
                                            if(selectobj[0].bedueDays > 7){
                                                maxReduce = parseFloat(selectobj[0].repayAmount) - parseFloat(selectobj[0].reduceAmount) >=parseFloat(selectobj[0].payAmount) ? parseFloat(selectobj[0].surplusTotalAmount).toFixed(2): (parseFloat(selectobj[0].surplusTotalAmount) + parseFloat(selectobj[0].repayAmount) - parseFloat(selectobj[0].loanAmount) - parseFloat(selectobj[0].reduceAmount)).toFixed(2) ;
                                            }else {
                                                maxReduce = (parseFloat(selectobj[0].penalty) - parseFloat(selectobj[0].reduceAmount)).toFixed(2);
                                                if(parseFloat(maxReduce) >　parseFloat(selectobj[0].surplusTotalAmount)){
                                                    maxReduce = selectobj[0].surplusTotalAmount;
                                                }
                                            }
                                            if(maxReduce < 0 ){
                                                maxReduce = 0;
                                            ...
                                            $("#reduceAmount").val(result.data > maxReduce ? maxReduce : result.data);
                    ...
                    options: {
                        ...
                        onClick : function() {
                            ...
                            if (selectobj.length == 1) {
                                ...
                                //剩余应付+手机赎回费-押金（页面押金为负数）
                                var borrowId = selectobj[0].contractID;
                                ...
                                var ceiling = (surplusTotalAmountNum+ransomNum+depositNum).toFixed(2);//最大限额
