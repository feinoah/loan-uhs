...
public class AuthGenerator {
    ...
    private void createRoleButtonACL(List<Directory> dirs) {
        ...
        //removeRoleButtonACL(dirs, Role.POST_LOAN_MANAGER, "贷后管理", "批量扣款专用");
        //removeRoleButtonACL(dirs, Role.POST_LOAN_MANAGER, "贷后管理", "批量扣款列表");
        ...
        //setRoleButtonACL(dirs, Role.OPERATION_MANAGER, "系统设置", "快速编码");
