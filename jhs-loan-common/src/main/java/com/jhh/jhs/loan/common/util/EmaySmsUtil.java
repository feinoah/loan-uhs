...
public class EmaySmsUtil {
    ...
    private static final String SN_JHS = "EUCP-EMY-SMS1-4MFCE";
    ...
    private static final String key_jhs ="899550";
    ...
    public static boolean send(String message, String phone, int type) {
        ...
        try {
            ...
            if (type == 1) {
                ...
                param = "cdkey=" + SN_JHS+ "&password=" + key_jhs + "&phone=" + mdn + "&message=" + message + "&addserial="
                        + code + "&seqid=" + seqId;
                url = baseUrl_JHHJK + "sendsms.action";
            } else{
    ...
    public static void main(String[] args) {
        ...
        // "【悠多多】尊敬的用户，由于系统原因，悠多多于2017-06-20给您多放款了855元借款。故于2017-07-07从您的银行卡上扣回了855元。给您带来的不便敬请谅解。如有疑问请咨询400-150-8990。谢谢。
        // 请",
        // "13341814726", 1);

//		 boolean flag = EmaySmsUtil.send("【金狐贷】万泽中你好，快来申请悠多多。", "13341814726", 2);
//		boolean flag = EmaySmsUtil.send("", "13341814726", 1);

//		System.out.println(flag);

//		String message1 = "【悠多多】尊敬的用户，由于系统原因，悠多多于2017-06-19给您多放款了855元借款。故于2017-08-10从您的银行卡上扣回了855元。给您带来的不便敬请谅解。如有疑问请咨询400-150-8990。谢谢。";
//		String message2 = "【悠多多】尊敬的用户，悠多多已向您尾号XXXX的银行卡退款XXXX元，请注意查收。如有问题请拨打客服电话400-150-8990。";
...
//
//
//            String message = "【悠多多】尊敬的用户，请重新打开APP进行更新，更新后请重新进行认证，谢谢您的配合。";
