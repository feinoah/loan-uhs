...
public class Constants {
    ...
    public final static String SETTLEMENT_SWITCH = "zl:st:zl_bt:st:power:switch";
    ...
    public  static class PayStyleConstants{
        ...
        /**悠多多支付渠道ID代付*/
        public static final Integer YHS_PAY_APPID = 2;
        /**悠多多支付渠道ID代扣*/
        public static final Integer YHS_DEDUCT_APPID = 3;
        /**悠多多支付渠道ID代扣*/
        public static final Integer YHS_REPAY_SWITCH= 4;
        /**悠多多支付渠道ID批量代扣*/
        public static final Integer YHS_BATCH_APPID= 5;
        /**悠多多绑卡appid*/
        public static final Integer YHS_BIND_CARD_APPID= 6;
        /**悠多多绑卡appid*/
        public static final Integer YHS_SEND_MSG_APPID= 7;
        /**数据库具体支付渠道 codetype*/
