package com.jhh.jhs.loan.entity.common;
...
public class Constants {
     ...
     * redis前缀
     */
    public final static String YM_ADMIN_SYSTEN_KEY = "JHS_b_";
    ...
    public abstract static class OperationType {
        ...
        /********已签约拒绝**********/
        public static final Integer CONTRACT_REJECT = 5;
        /********已签约拉黑**********/
        public static final Integer CONTRACT_BLACK = 6;
