...
import com.jhh.jhs.loan.dao.CardMapper;
import com.jhh.jhs.loan.dao.OrderRobotMapper;
import com.jhh.jhs.loan.entity.app.BorrowList;
import com.jhh.jhs.loan.entity.common.Constants;
import com.jhh.jhs.loan.model.OrderRobot;
import com.jhh.jhs.loan.model.PromptData;
...
public class RobotServiceImpl implements RobotService {
    ...
    private static String corpCode = "悠多多";
    ...
    public void sendDataToBaikelu() {
        ...
        try {
            ...
            mailService.sendMail(to, copyto, "YHS_百可录逾期提醒异常", e.getMessage());
            log.error(e);
        }
    }
    ...
    private String getWorkData(Integer borrowId) {
        ...
        if (map != null) {
            ...
            String birthday = com.jhh.jhs.loan.common.util.DateUtil.getDateStringyyyymmdd((Date) map.get("birthday"));
