...
public class SmsUtil {
	...
	public static String sendSms(long tpl, String content, String mobile) {
		String result = "【悠多多】您的验证码是"+content;
...
//		}
	...
	public static String sendSmsFangKuanOk(long tpl, String realname,
        ...
        // String result =
        // "【悠多多】尊敬的"+realname+"，您申请的"+money+"、"+date+"借款已发放至您指定账户，请注意查收。请不要忘记在"+repayment_date+"及时还款。";
        String result = "【悠多多】尊敬的用户，您申请的" + money + "、" + date + "借 款已发放至您指定账户，请注意查收。请不要忘记在" + repayment_date
                + "及时还 款。";
...
//		}
	...
	public static String sendSmsHuanKuanTixing(long tpl, String realname,String repayment_money,
        ...
        // 2017.5.8更改 用户名字一律换成 用户两个字
        // String result =
        // "【悠多多】尊敬的"+realname+"，您本次账单人民币"+repayment_money+"。到期还款日"+repayment_date+"。";
        String result = "【悠多多】尊敬的用户，您本次账单人民币" + repayment_money + "。到期回 款日" + repayment_date + "。"
...
//		}
	...
	*@version 1.0
	...
	public static String checkNoSms(long tpl, String content, String mobile) {
        // 2017.5.8更改 用户名字一律换成 用户两个字
        // String result = "【悠多多】尊敬的"+content+"，由于您的账户存在重大风险，发放借款失败。";
        String result = "【悠多多】尊敬的用户，由于您的账户存在重大风险，发放借 款失败。";
